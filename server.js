...
const SOURCES = {
  ...
  cnn:{page:'https://edition.cnn.com/world', feeds:['https://rss.cnn.com/rss/cnn_topstories.rss','https://rss.cnn.com/rss/edition.rss'], googleQuery:'site:cnn.com/news OR site:edition.cnn.com', items:['article','.container__item','.card'], title:['.container__headline-text','h3','h2'], link:['a[href]'], desc:['.container__description','p'], image:['img'], date:['time[datetime]','time']},
  ...
  guardian:{page:'https://www.theguardian.com/world', feeds:['https://www.theguardian.com/world/rss'], googleQuery:'site:theguardian.com/world', items:['article','.fc-item'], title:['h3','.fc-item__title','h2'], link:['a[href]'], desc:['.fc-item__standfirst','p'], image:['img'], date:['time[datetime]','time']},
  ...
  skynews:{page:'https://news.sky.com/world', feeds:['https://feeds.skynews.com/feeds/rss/world.xml','https://feeds.skynews.com/feeds/rss/home.xml'], googleQuery:'site:news.sky.com', items:['article','.sdc-site-tile','.sdc-news-article'], title:['h3','h2'], link:['a[href]'], desc:['p'], image:['img'], date:['time[datetime]','time']},
  ...
  nbc:{page:'https://www.nbcnews.com/world', feeds:['https://feeds.nbcnews.com/nbcnews/public/world','https://feeds.nbcnews.com/nbcnews/public/news'], googleQuery:'site:nbcnews.com', items:['article','li','[data-testid="story-card"]'], title:['h2','h3'], link:['a[href]'], desc:['p'], image:['img'], date:['time[datetime]','time']},
  reuters:{page:'https://www.reuters.com/world/', feeds:['https://www.reutersagency.com/feed/?best-topics=world&post_type=best'], googleQuery:'site:reuters.com/world OR site:reuters.com/world/', items:['article','[data-testid="MediaStoryCard"]','.story-card'], title:['h3','h2','[data-testid="Heading"]'], link:['a[href]'], desc:['p'], image:['img'], date:['time[datetime]','time']},
  abc:{page:'https://abcnews.go.com/International', feeds:['https://feeds.abcnews.com/abcnews/internationalheadlines','https://feeds.abcnews.com/abcnews/worldnewsheadlines'], googleQuery:'site:abcnews.go.com/International', items:['article','.ContentList__Item','.Card'], title:['h2','h3'], link:['a[href]'], desc:['p'], image:['img'], date:['time[datetime]','time']},
  irna:{page:'https://www.irna.ir/', feeds:['https://www.irna.ir/rss'], googleQuery:'site:irna.ir', items:['article','.item','.news-item','li'], title:['h2','h3','.title'], link:['a[href]'], desc:['.lead','p'], image:['img'], date:['time[datetime]','time']},
  isna:{page:'https://www.isna.ir/', feeds:['https://www.isna.ir/rss'], googleQuery:'site:isna.ir', items:['article','.item','.news-item','li'], title:['h2','h3','.title'], link:['a[href]'], desc:['.lead','p'], image:['img'], date:['time[datetime]','time']},
  mehr:{page:'https://www.mehrnews.com/', feeds:['https://www.mehrnews.com/rss'], googleQuery:'site:mehrnews.com', items:['article','.item','.news-item','li'], title:['h2','h3','.title'], link:['a[href]'], desc:['.lead','p'], image:['img'], date:['time[datetime]','time']},
  tasnim:{page:'https://www.tasnimnews.com/fa', feeds:['https://www.tasnimnews.com/fa/rss/feed/0/7/0/%D8%A7%D8%AE%D8%A8%D8%A7%D8%B1-%D8%A7%D8%B5%D9%84%DB%8C'], googleQuery:'site:tasnimnews.com/fa', items:['article','.item','.news-item','li'], title:['h2','h3','.title'], link:['a[href]'], desc:['.lead','p'], image:['img'], date:['time[datetime]','time']},
  fars:{page:'https://www.farsnews.ir/', feeds:['https://www.farsnews.ir/rss'], googleQuery:'site:farsnews.ir', items:['article','.item','.news-item','li'], title:['h2','h3','.title'], link:['a[href]'], desc:['.lead','p'], image:['img'], date:['time[datetime]','time']},
  khabaronline:{page:'https://www.khabaronline.ir/', feeds:['https://www.khabaronline.ir/rss'], googleQuery:'site:khabaronline.ir', items:['article','.item','.news-item','li'], title:['h2','h3','.title'], link:['a[href]'], desc:['.lead','p'], image:['img'], date:['time[datetime]','time']},
  entekhab:{page:'https://www.entekhab.ir/', feeds:['https://www.entekhab.ir/fa/rss/allnews'], googleQuery:'site:entekhab.ir', items:['article','.item','.news-item','li'], title:['h2','h3','.title'], link:['a[href]'], desc:['.lead','p'], image:['img'], date:['time[datetime]','time']},
  etemadonline:{page:'https://www.etemadonline.com/', feeds:['https://www.etemadonline.com/rss'], googleQuery:'site:etemadonline.com', items:['article','.item','.news-item','li'], title:['h2','h3','.title'], link:['a[href]'], desc:['.lead','p'], image:['img'], date:['time[datetime]','time']},
  jamaran:{page:'https://www.jamaran.news/', feeds:['https://www.jamaran.news/rss'], googleQuery:'site:jamaran.news', items:['article','.item','.news-item','li'], title:['h2','h3','.title'], link:['a[href]'], desc:['.lead','p'], image:['img'], date:['time[datetime]','time']},
  asriran:{page:'https://www.asriran.com/', feeds:['https://www.asriran.com/fa/rss/allnews'], googleQuery:'site:asriran.com', items:['article','.item','.news-item','li'], title:['h2','h3','.title'], link:['a[href]'], desc:['.lead','p'], image:['img'], date:['time[datetime]','time']},
  tabnak:{page:'https://www.tabnak.ir/', feeds:['https://www.tabnak.ir/fa/rss/allnews'], googleQuery:'site:tabnak.ir', items:['article','.item','.news-item','li'], title:['h2','h3','.title'], link:['a[href]'], desc:['.lead','p'], image:['img'], date:['time[datetime]','time']},
  mizanonline:{page:'https://www.mizanonline.ir/', feeds:['https://www.mizanonline.ir/fa/rss/allnews'], googleQuery:'site:mizanonline.ir', items:['article','.item','.news-item','li'], title:['h2','h3','.title'], link:['a[href]'], desc:['.lead','p'], image:['img'], date:['time[datetime]','time']},
...
const GOOGLE_NEWS_HEADERS = {
  'User-Agent':'Mozilla/5.0 (compatible; NewsAggregator/4.1; +https://news.google.com/)'
};

function googleNewsFeedUrl(source){
  if(!source.googleQuery) return '';
  const lang = source.group === 'iran' ? 'fa' : 'en-US';
  const gl = source.group === 'iran' ? 'IR' : 'US';
  const ceid = source.group === 'iran' ? 'IR:fa' : 'US:en';
  return `https://news.google.com/rss/search?q=${encodeURIComponent(source.googleQuery)}&hl=${encodeURIComponent(lang)}&gl=${gl}&ceid=${encodeURIComponent(ceid)}`;
}
...
async function resolveRedirect(url){
  try{
    ...
    try{
      const r=await fetch(url,{signal:c.signal,redirect:'follow',headers:GOOGLE_NEWS_HEADERS});
      return r.url || url;
    }finally{clearTimeout(t)}
  }catch{return url}
}

async function parseGoogleFeed(url,source){
  const feed=await parser.parseURL(url);
  const items=(feed.items||[]).slice(0,35).map(x=>normalize(x,source,url)).filter(Boolean);
  const resolved=await Promise.all(items.map(async item=>{
    item.link=await resolveRedirect(item.link);
    item.id=`${source.id}|${item.link}`;
    item.method='google-news-rss';
    return item;
  }));
...
async function fetchSource(source){
  ...
  // 1) Source-owned RSS feeds first. These are the preferred path.
  for(const feed of (cfg.feeds||[])){
    try{
      const items=await parseFeed(feed,source);
      if(items.length) return {items,method:'rss',sourceUrl:feed};
    }catch(e){errors.push(`rss:${new URL(feed).hostname}:${e.message}`)}
  }

  // 2) Per-source Google News RSS mirror. This is intentionally source-scoped
  // (site:domain) rather than a generic news feed, so a blocked publisher does
  // not block the rest of the system and articles still point back to the source.
  try{
    const gn=googleNewsFeedUrl(cfg);
    if(gn){
      const items=await parseGoogleFeed(gn,source);
      if(items.length) return {items,method:'google-news-rss',sourceUrl:gn};
    }
  }catch(e){errors.push(`google-news-rss:${e.message}`)}

  // 3) Server-side HTML extraction as a last source-specific fallback.
  try{
    const items=await parseHtml(cfg.page,source,cfg);
    if(items.length) return {items,method:'site-html',sourceUrl:cfg.page};
  }catch(e){errors.push(`html:${e.message}`)}

  throw new Error(errors.join(' | ')||'No articles found');
}
...
setInterval(()=>backgroundPoll().catch(()=>{}),3*60*1000);
